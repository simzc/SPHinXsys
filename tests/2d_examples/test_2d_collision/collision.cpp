...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<GravityForce> constant_gravity_force_free_ball(free_ball, gravity);
    SimpleDynamics<GravityForce> constant_gravity_force_damping_ball(damping_ball, gravity);
    ...
    //----------------------------------------------------------------------
    constant_gravity_force_free_ball.exec();
    constant_gravity_force_damping_ball.exec();
