...
int main(int ac, char *av[])
{
    ...
    InteractionWithUpdate<fluid_dynamics::SurfaceTensionForceComplex> water_surface_tension_force(water_inner, water_air_contact);
    water_block.addBodyStateForRecording<Matd>("SurfaceTensionStress");
    InteractionWithUpdate<fluid_dynamics::SurfaceTensionForceComplex> air_surface_tension_force(air_inner, air_water_contact);
