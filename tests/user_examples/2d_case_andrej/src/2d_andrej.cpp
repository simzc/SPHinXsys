...
class WallBoundaryInner : public MultiPolygonShape
{
  public:
...
class WallBoundaryOuter : public MultiPolygonShape
{
  public:
    explicit WallBoundaryOuter(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        multi_polygon_.addAPolygon(outer_boundary, ShapeBooleanOps::add);
