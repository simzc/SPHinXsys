...
int main()
{
	...
	BodyRegionByCell damping_buffer(water_block, makeShared<TransformShape<GeometricShapeBox>>(Transformd(translation_damping), halfsize_damping));
	...
	*/
	...
	/** WaveProbes. */
	BodyRegionByCell wave_probe_buffer_no_4(water_block, makeShared<TransformShape<GeometricShapeBox>>(Transformd(translation_No4), halfsize_No4, "WaveProbe_04"));
	...
	BodyRegionByCell wave_probe_buffer_no_5(water_block, makeShared<TransformShape<GeometricShapeBox>>(Transformd(translation_No5), halfsize_No5,  "WaveProbe_05"));
	ReducedQuantityRecording<ReduceDynamics<fluid_dynamics::FreeSurfaceHeight>>
		wave_probe_5(io_environment, wave_probe_buffer_no_5);

	BodyRegionByCell wave_probe_buffer_no_12(water_block, makeShared<TransformShape<GeometricShapeBox>>(Transformd(translation_No12), halfsize_No12, "WaveProbe_12"));
	ReducedQuantityRecording<ReduceDynamics<fluid_dynamics::FreeSurfaceHeight>>
