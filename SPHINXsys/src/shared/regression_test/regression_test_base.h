...
namespace SPH
{
	...
	public:
																 ...
																 result_xml_engine_out_("result_xml_engine_out", "result")
		{
			...
			result_filefullpath_ = input_folder_path_ + "/" + this->dynamics_range_name_ + "_" + this->quantity_name_ + "_result.xml";
			runtimes_filefullpath_ = input_folder_path_ + "/" + this->dynamics_range_name_ + "_" + this->quantity_name_ + "_runtimes.dat";
