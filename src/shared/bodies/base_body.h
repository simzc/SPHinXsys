...
class RealBody : public SPHBody
{
  private:
    ...
    StdVec<BaseDynamics<void> *> pre_processes_;  /*< operations before update cell inked list */
    StdVec<BaseDynamics<void> *> post_processes_; /*< operations after update cell inked list */
    /**
  ...
  public:
    ...
    void addBeforeUpdateCellLinkedList(BaseDynamics<void> *process);
    void addAfterUpdateCellLinkedList(BaseDynamics<void> *process);
