...
//=================================================================================================//
void RealBody::addBeforeUpdateCellLinkedList(BaseDynamics<void> *process)
{
    pre_processes_.push_back(process);
}
//=================================================================================================//
void RealBody::addAfterUpdateCellLinkedList(BaseDynamics<void> *process)
{
    post_processes_.push_back(process);
}
//=================================================================================================//
void RealBody::updateCellLinkedList()
{
    for (size_t i = 0; i != pre_processes_.size(); i++)
    {
        pre_processes_[i]->exec();
    }
