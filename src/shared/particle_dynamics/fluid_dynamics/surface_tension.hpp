...
SurfaceTensionForce<DataDelegationType>::SurfaceTensionForce(BaseRelationType &base_relation)
    : LocalDynamics(base_relation.getSPHBody()), ForcePrior(&base_particles_, "SurfaceTensionForce"),
      DataDelegationType(base_relation), rho_(base_particles_.rho_), Vol_(base_particles_.Vol_),
