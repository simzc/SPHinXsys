    ...
    : DensitySummation<Base, FluidContactData>(contact_relation)
{
    ...
    {
        StdLargeVec<Real> &Vol = *contact_particles_[k]->getVariableByName<Real>("VolumetricMeasure");
        contact_Vol0_.push_back(contact_particles_[k]->registerSharedVariable<Real>(
            "InitialVolumetricMeasure", [&](size_t index_i)
            { return Vol[index_i]; }));
    }
}
//=================================================================================================//
